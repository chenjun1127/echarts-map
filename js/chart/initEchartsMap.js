export function initEchartsMap(pName, Chinese_, data) {
  ...
  var option = {
    ...
    tooltip: {
      ...
      formatter: function (params) {
        return '<p>' + params.name + '</p><p class="conut-next">车位个数：' + params.value[2] + '个</p><p class="conut-next">已使用个数：' + params.value[3] + '个</p>';
      },
    ...
    series: [
      {
        ...
        //   {
        //     name: '新乡',
        //     value: [116.402217, 35.311657, 200, 300]
        //   },
        //   {
        //     name: '星河',
        //     value: [114.06594, 22.609866, 2000, 20]
        //   }
        // ]
        data: JSON.parse(sessionStorage.getItem('mapData'))
      }
    ]
  };
  // chartMap为window全局对象
  ...
  if (pName === 'china') {
    ...
    //   // }
    // });
    // chartMap.on('dblclick', function (param) {
    //   if (param.name !== 'china') {
    ...
    // for (var i = 0; i < provincesText.length; i++) {
    //   // console.log(pName === provincesText[i])
